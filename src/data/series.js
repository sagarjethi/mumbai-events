...
export const SERIES = {
  'gff-2026': {
    ...
    // Official counters from globalfintechfest.com (2026 site, "Powering the Next Wave" block), re-read 2026-09-06 evening after the site updated them.
    stats: [
      { label: 'Footfall', value: 100000, suffix: '+', key: true },
      { label: 'Participating institutions', value: 8000, suffix: '+', key: true },
      { label: 'Startups', value: 5000, suffix: '+', key: true },
      { label: 'Speakers', value: 1200, suffix: '+', key: true },
      { label: 'Countries', value: 80, suffix: '+', key: true },
      { label: 'Exhibitors', value: 350, suffix: '+', key: true },
      { label: 'Investors', value: 500, suffix: '+' },
      { label: 'Sessions', value: 450, suffix: '+' },
      { label: 'Founders', value: 200, suffix: '+' },
      { label: 'Product launches', value: 200, suffix: '+' },
      { label: 'Regulators', value: 120, suffix: '+' },
      { label: 'Masterclasses', value: 75, suffix: '+' },
