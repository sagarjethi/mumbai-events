...
export default function FintechWeekPage() {
  ...
  const faqs = [
    ...
    { q: 'Which night has the most side events?', a: 'Wednesday 9 and Thursday 10 September are both packed. Sep 9: the CEOs’ Dinner, the Citi, HSBC and Persistent dinners, the Fintech Happy Hour, and the Uptik, Paysprint and Infobip night fests. Sep 10: the Scapia Sundowner with Salim–Sulaiman, the Activate × AWS × Anthropic AI Sundowner, ElevenLabs × Lightspeed at O Pedro, the Adyen and Karix dinners, the Open Financial and GetePay night fests and the No KYC Required BFSI mixer.' },
