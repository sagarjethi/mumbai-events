...
export default function Header() {
  return (
    <header className="relative overflow-hidden bg-white border-b border-slate-200">
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 text-center">
        <div className="inline-flex items-center gap-2 bg-primary-100 text-primary-700 px-3 py-1 rounded-full text-xs font-semibold mb-4">
          <Sparkles className="w-3.5 h-3.5" />
          {EVENT_COUNT}+ events · June–September 2026 · Mumbai
        </div>

        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight leading-[1.05]">
          Every tech event in{' '}
