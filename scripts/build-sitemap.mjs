...
add('/events/september-2026', { changefreq: 'daily', priority: 0.95 });
add('/fintech-week-mumbai-2026', { changefreq: 'daily', priority: 0.95 });
...
// Deals / discount-codes hub
add('/deals', { changefreq: 'daily', priority: 0.9 });
